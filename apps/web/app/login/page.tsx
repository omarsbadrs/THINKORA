  ...
  return (
    <>
      <style>{`
        ...
        .auth-forgot { display: block; text-align: right; font-family: monospace; font-size: 11px; color: rgba(224,224,224,0.3); text-decoration: none; letter-spacing: 0.04em; margin-bottom: 20px; transition: color 0.2s; }
        .auth-forgot:hover { color: #ff3c00; }
        .auth-submit { width: 100%; padding: 14px 20px; background: #ff3c00; color: #fff; font-family: 'Syncopate', sans-serif; font-weight: 700; font-size: 12px; letter-spacing: 0.1em; border: none; clip-path: polygon(0 0,100% 0,100% 70%,95% 100%,0 100%); cursor: pointer; transition: background 0.2s, transform 0.15s; }
      ...
      <div className="auth-root">
        ...
        <div aria-hidden style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 1 }}>
          <div style={{ position: 'absolute', top: '-20%', left: '-10%', width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,60,0,0.07) 0%, transparent 70%)', filter: 'blur(40px)' }} />
          <div style={{ position: 'absolute', bottom: '-20%', right: '-10%', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,60,0,0.04) 0%, transparent 70%)', filter: 'blur(40px)' }} />
        </div>
        ...
        <div className="auth-card" style={{ zIndex: 10 }}>
          ...
          <p className="auth-sub">[ AI COMMAND CENTER // SIGN IN ]</p>
